...
st.markdown(
    ...
    body {
        background: linear-gradient(to right, #FF9A8B, #FEC8D8); /* Pink to Peach gradient */
        font-family: 'Arial', sans-serif;
    }

    /* Set a warm color for headers */
    .streamlit-expanderHeader {
        color: #D15B5B; /* Warm red */
        font-size: 24px;
    }

    /* Button styling with hover effect */
    .stButton>button {
        background-color: #F2A154; /* Warm orange */
        color: white;
        border-radius: 10px;
        font-weight: bold;
        padding: 12px 30px;
    ...
    .stButton>button:hover {
        background-color: #D67C2B; /* Darker warm orange */
        transform: scale(1.05);
        transition: transform 0.2s ease-in-out;
    }

    /* Card-like layout for input fields and sections */
    .stTextInput>div, .stTextArea>div {
        background-color: #FFF1D0; /* Soft cream background */
        border-radius: 15px;
    ...
    /* Customize the title */
    .css-1v3fvcr {
        color: #9F6D58; /* Warm brown */
        text-align: center;
    }

    /* Add some hover effect for text sections */
    .css-16hu3q5 {
        color: #7A5D3B; /* Muted warm brown */
        transition: color 0.3s ease-in-out;
    }
    .css-16hu3q5:hover {
        color: #D15B5B; /* Warm red on hover */
    }

    /* Style the sidebar */
    .css-1d391kg {
        background-color: #FFF1D0; /* Light cream background for sidebar */
        border-radius: 10px;
    }

    /* Input Fields Text Color */
    .stTextInput>div>div>input, .stTextArea>div>div>textarea {
        background-color: #F8E4B6; /* Light warm yellow */
        color: #3C1D12; /* Dark brown text */
    }
    .stTextInput>div>div>input:focus, .stTextArea>div>div>textarea:focus {
        border: 2px solid #D15B5B; /* Red border on focus */
    }

    /* Add a border around the button area */
    .stButton>button {
        border: 2px solid #F2A154; /* Matching border around buttons */
        padding: 10px 28px;
    }

    /* Additional styling for Streamlit's markdown text */
    .css-1e4nxb1 {
        font-size: 16px;
        color: #7A5D3B; /* Muted warm brown */
    }
